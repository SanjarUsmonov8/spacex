...
export default async function Falconheavy() {
    const res = await fetch('http://127.0.0.1:8000/');
    const data = await res.json();
    const specificItem6 = data.find((item: any) => item.id === 6)
    ...
    return (
            ...
            <div className="relative w-full overflow-hidden">
                <div>
                    <img
                        ...
                        src="https://www.spacex.com/assets/images/vehicles/falcon-heavy/fh_feature.jpg"
      ...
      */}
        ...
        `}</style>
                    ...
                    <h1 className="font-bold text-8xl text-white">FALCON HEAVY</h1>
                    ...
                    <div>
                        <div>
                            <div className="flex justify-around w-120 gap-80 pb-5">
                                <h1 className="text font-mono font-light tracking-tight">{specificItem6.part1}</h1>
                                <p className="">{specificItem6.part4}</p>
                            </div>
                            <div className="h-[1px] w-120 bg-zinc-500" />
                        </div>
                        <div>
                            <div className="flex justify-around w-120 gap-80 pb-5 pt-6">
                                <h1 className="text font-mono font-light tracking-tight">{specificItem6.part2}</h1>
                                <p className="">{specificItem6.part5}</p>
                            </div>
                            <div className="h-[1px] w-120 bg-zinc-500" />
                        </div>
                        <div>
                            <div className="flex justify-around w-120 gap-60 pb-5 pt-6">
                                <h1 className="text font-mono font-light tracking-tight">{specificItem6.part3}</h1>
                                <p className="">{specificItem6.part6}</p>
                            </div>
                            <div className="h-[1px] w-120 bg-zinc-500" />
                        </div>
                    </div>
                </div>
                <div className="ml-180 w-120"><img className="object-cover w-full h-full" src="https://dsuj2mkiosyd2.cloudfront.net/unified-gallery/211130/2938/ad9b61d2/falcon-heavy-v15_800-auto.webp?t=1680292656" style={{ clipPath: 'inset(0% 15% 0% 0%)' }} alt="" /></div>
            </div>
            <div><img src="https://www.spacex.com/assets/images/vehicles/falcon-heavy/FH_5.jpg" alt="" /></div>
            <Footer/>
        </div>
    )
}