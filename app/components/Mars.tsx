    ...
    <div>
      <div className="relative w-full bg-black overflow-hidden">
        <div className="absolute inset-0 z-10 pt-80 pl-25 "><h1 className="uppercase font-bold text-7xl w-150">Making life multiplanetary</h1>
          <h1 className="w-150 py-7">SpaceX was founded under the belief that a future where humanity is out exploring the stars is fundamentally more exciting than one where we are not.</h1></div>
        <div><img
      ...
      <div className="relative w-full overflow-hidden ">
        ...
        <div className="z-10 absolute inset-0 pl-205 pt-30"><h1 className="uppercase font-bold text-5xl">Revolutionizing space <p className="pt-5">technology</p></h1>
          <h1 className="py-7">SpaceX`s Starship spacecraft and Super Heavy rocket is a fully reusable transportation system designed to carry both crew and cargo to Earth orbit, the Moon, Mars, and beyond.</h1></div>
      </div>
      <div className="relative w-full overflow-hidden ">
        ...
        <div className="z-10 absolute inset-0 pt-25 pl-20"><h1 className="uppercase font-bold text-5xl w-200">World`s leading launch service provider</h1>
          <h1 className="w-200 py-7">SpaceX leads the world in launches with its reliable, reusable rockets and is developing the fully and rapidly reusable rockets necessary to transform humanity`s ability to access space into something as routine as air travel.</h1></div>
      ...
      <div className="relative w-full overflow-hidden ">
        ...
        <h1 className="w-170">Since returning human spaceflight capabilities to the United States in 2020, SpaceX is helping build a new era where not just hundreds of people, but thousands and ultimately millions will be able to explore space.</h1></div>
      </div>
      <div className="relative w-full overflow-hidden ">
