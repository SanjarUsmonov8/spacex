    ...
    <div>
      <div className="relative w-full bg-black overflow-hidden">
        <div className="absolute inset-0 z-10 pt-80 pl-25 "><h1 className="uppercase font-bold text-7xl w-150">Making life multiplanetary</h1>
          ...
          <a href="/marsp"><div className="bg-black/60 w-30 h-12 flex items-center justify-center rounded-sm border-1 border-white/50"><h1 className="text-xs" >EXPLORE →</h1></div></a></div>
        <div><img
      ...
      <div className="relative w-full overflow-hidden ">
        ...
        <div className="z-10 absolute inset-0 pl-205 pt-30"><h1 className="uppercase font-bold text-5xl">Revolutionizing space <p className="pt-5">technology</p></h1>
          ...
          <a href="/dragon"><div className="bg-black/60 w-35 h-12 flex items-center justify-center rounded-sm border-1 border-white/50"><h1 className="text-xs" >LEARN MORE →</h1></div></a></div>
      </div>
      <div className="relative w-full overflow-hidden ">
        ...
        <div className="z-10 absolute inset-0 pt-25 pl-20"><h1 className="uppercase font-bold text-5xl w-200">World`s leading launch service provider</h1>
          ...
          <a href="/falcon9"><div className="bg-black/60 w-45 h-12 flex items-center justify-center rounded-sm border-1 border-white/50"><h1 className="text-xs" >RESERVE YOUR RIDE →</h1></div></a></div>
      ...
      <div className="relative w-full overflow-hidden ">
        ...
        <a href="/hs"><div className="bg-black/60 w-35 h-12 flex items-center justify-center rounded-sm border-1 border-white/50"><h1 className="text-xs" >JOIN A MISSON →</h1></div></a></div>
      </div>
      <div className="relative w-full overflow-hidden ">
